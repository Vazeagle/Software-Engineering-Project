...
def main():
    ...
    label_l_down = Label(label_left ,borderwidth=1 ,highlightthickness=0, bg="salmon1"  )  # button gia menu kai alla frames
    ...
    label_rddrru_right = Label(label_rddrr_up ,borderwidth=1 ,highlightthickness=0, bg="salmon1"  )  # lukeio input from db
    ...
    descriptionText =Text(label_rul_right ,height=7 ,bg="salmon1" ,borderwidth=0 ,highlightthickness=0,font=("Calibri", 14), width = 100)
